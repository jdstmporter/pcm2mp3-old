...
OBJ := $(addprefix cpp/lib/,MP3Encoder.o MP3Data.o MP3File.o  Iterator32.o PCMData.o PCMFile.o WAVFile.o AIFFFile.o base.o DataChunk.o Form.o Conversions.o transcoder.o)
